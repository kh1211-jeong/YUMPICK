...
# CLAUDE.md — Yumvote (그룹 점심 메뉴 결정 서비스)
...
**후보 3곳으로 좁혀 그룹 투표로 오늘 점심을 확정하는** 웹 서비스.

- 서비스명: **Yumvote** (yum 냠 + vote 투표)
...
- **페르소나**: 정기흔, 26세. 회사 근처에서 팀원 3명과 매일 점심 메뉴 정하는 데 지친 사회초년생.
...
### 3-4. 후보 제시 & 투표
- AI가 전원 프롬프트를 종합 → **식당 후보 정확히 3곳**으로 좁혀 제시.
- 각 후보에 **별점 · 원본 상세 사이트 링크** 표시.
- 그룹원이 후보 3곳 중 투표(1인 1표) → 최다 득표 메뉴/식당 확정.
...
- 후보는 **정확히 3곳**. 더 많이 주지 말 것(선택지 많으면 또 못 정함 = 제품 철학).
